...
-----
    ...
    Project 3: Simple New Video Game in Python
...
------------ 
    ...
    Michael Romero
    CWID: 890228026
    email: romerom@csu.fullerton.edu
...
--------------
    ...
    Main menu song beat
    In-game trance score
    Accurate enemy targeting system
    Player mouse targeting
    Shooting sound fx
    Exploding sound fx
    Bouncing game over rabbit
